...
public class LoginPage extends BasePage{
    ...
    private static final String MODAL_SELECTOR = "#mat-dialog-0 > app-welcome-banner > div > div:nth-child(3) > " +
            "button.mat-focus-indicator.close-dialog.mat-raised-button.mat-button-base.mat-primary.ng-star-inserted > " +
            "span.mat-button-wrapper > mat-icon"; //CSS
